...
<html>
<head>
<title>Music Band  A music category Flat bootstrap Responsive  Website Template | Home :: w3layouts</title>
	...
	<div class="container">
		<div class="header">
		 ...
		 <div class="banner-main">
		 	<div class="bann-text">
			  	 <h3>Lorem ipsum dolor consectetur sed do eiusmod tempor</h3>
			  	 <a href="#">Click Here</a>
			</div>
		</div>
  </div>
	...
	<div class="container">
		<div class="singer-main">
			  <div class="col-md-4 singer-left">
			  	<a href="#"><img src="images/sing.jpg"></a>
			  </div>
				...
				<div class="col-md-6 program-gridleft">
					...
					<div class="quoteation">
						...
						<div class="quote-text">
							<h5>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium.</h5>
		...
		<div class="features-main">
			<h3>Feature Events</h3>
			 <div class="fea-grid-bottom">
			 	<div class="col-md-4 fea-grid">
				 	<h5>4-08-2015</h5>
				 	<h4> Nam libero tempore soluta nobis</h4>
